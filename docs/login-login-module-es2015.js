...
/* harmony default export */ __webpack_exports__["default"] = ("<app-auth-form (submitted)=\"loginUser($event)\">\r\n  <h1>Login</h1>\r\n  <a routerLink=\"/auth/register\">Not registered?</a>\r\n  <button type=\"submit\" class=\"login\">Login</button>\r\n  <div class=\"error\" *ngIf=\"error\">{{ error }}</div>\r\n  <button type=\"button\" (click)=\"googleAuth()\" class=\"google\">Google</button>\r\n</app-auth-form>\r\n");
...
let LoginComponent = class LoginComponent {
    ...
    googleAuth() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                yield this.authService.loginGoogleUser();
                this.router.navigate(['/']);
            }
            catch (err) {
                this.error = err.message;
...
LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-login',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./login.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/auth/login/containers/login/login.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./login.component.scss */ "./src/app/auth/login/containers/login/login.component.scss")).default]
    })
], LoginComponent);
...
const ROUTES = [
    { path: '', component: _containers_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"] }
];
